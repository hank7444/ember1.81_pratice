(function(f, j, d) {
    var m = "watermark",
        ...
        c = "watermarkFocus",
        i = "watermarkSubmit",
        e = "watermarkMaxLength",
        g = "watermarkPassword",
        q = "watermarkText",
        l = /\r/g,
        o = /^(button|checkbox|hidden|image|radio|range|reset|submit)$/i,
        b = "input:data(" + m + "),textarea:data(" + m + ")",
        k = ":watermarkable",
    ...
    f.fn.watermark = f.fn.watermark || function(u, r) {
        ...
        if (typeof(r) === "object") {
            ...
            if (typeof(r) === "string") {
                t = true;
                r = f.extend({}, f.watermark.options, {
                    className: r
                })
            } else {
        ...
        return this.each(function() {
            ...
            if (z.data(m)) {
                ...
                if ((z.attr("type") || "") === "password") {
                    var v = z.wrap("<span>").parent(),
                        y = f(v.html().replace(/type=["']?password["']?/i, 'type="text"'));
                    y.data(q, z.data(q));
                    y.data(h, z.data(h));
                    y.data(m, 1);
